...
class JsonStore {
  ...
  saveSettings () { writeJson(this.settingsFile, this.settings) }
...
function defaultSettings () {
  return { network: { ssid: '', password: '', mdnsDomain: 'yey.boats' }, ota: { password: '' }, numbering: { prefix: 'yey-d-', next: 1, pad: 3 } }
}
