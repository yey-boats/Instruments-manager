...
const dev = new MockFirmware(manager, { deviceId: 'yey-d-aaaaaaaaaaaa', auth, name: '', display: { width: 480, height: 480, shape: 'square', rotation: 0, colorDepth: 16 } })
dev.register()
const rec = manager.store.registry.devices['yey-d-aaaaaaaaaaaa']
...
dev.register()
assert.equal(manager.store.registry.devices['yey-d-aaaaaaaaaaaa'].assignedNumber, 'boat-07', 're-register keeps number')
