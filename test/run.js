...
require('./ota-validate.test')
require('./manifest.test')
require('./settings.test')
require('./provision-number.test')
require('./provision-config.test')
require('./ui-restructure.test')
require('./marker-preview.test')
